...
### Option 1B: Frontend client on Google Colab
`pip install luminescent`

Unlike before, we're only installing the python frontend client. This only takes a minute and the basic free CPU runtime is sufficient. [Google Colab example](https://colab.research.google.com/drive/1g1sjXUTavK5ceZ-AeKyHQolpP2-RD0rd?usp=sharing)
...
Customers of Enterprise Cluster are also entitled to local backend binaries upon request. 