...
require(['jquery', 'minisearch'], function ($, minisearch) {
  ...
  // list below is the lunr 2.1.3 list minus the intersect with names(mask)
    ...
    let result_div = `
      ...
      documenterBaseURL + "/" + result.location
        ...
        <div class="w-100 is-flex is-flex-wrap-wrap is-justify-content-space-between is-align-items-flex-start">
          <div class="search-result-title has-text-weight-bold ${in_code ? "search-result-code-title" : ""
      }">${result.title}</div>
  ...
  function get_filters() {
    let ele = $(".search-filters .search-filter-selected").field();
...
require(['jquery'], function ($) {
  ...
  $(document).ready(function () {
    var sidebar = $("#documenter .docs-menu").field(0);
    var active = $("#documenter .docs-menu .is-active").field(0);
