...
@showtime sol0 = accumulate((u, t) -> update(u, p0, t, field_padding, source_instances), 0:dt:T, init=u0)
@showtime sol = accumulate((u, t) -> update(u, p, t, field_padding, source_instances), 0:dt:T, init=u0)
