...
@showtime sol0 = accumulate((u, t) -> step3(u, p0, t, field_padding, source_effects), 0:dt:T, init=u0)
@showtime sol = accumulate((u, t) -> step3(u, p, t, field_padding, source_effects), 0:dt:T, init=u0)
